                                                ...
                                                <td class="px-1 py-2 text-center align-middle text-gray-400 select-none relative">
                                                    <div class="flex items-center justify-center space-x-1">
                                                        ...
                                                        <button type="button"
                                                                ...
                                                                class="opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto text-red-400 hover:text-red-600 hover:bg-red-50 p-0.5 rounded transition shrink-0"
                                                                title="Remove row">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            class="opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition absolute left-1/2 -translate-x-1/2 -bottom-2.5 z-20 w-5 h-5 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white rounded-full flex items-center justify-center shadow-md hover:scale-110"
