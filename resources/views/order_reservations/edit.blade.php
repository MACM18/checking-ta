        ...
        <div class="flex items-center justify-between">
            ...
            @if($orderReservation->document_id)
                <div class="flex items-center">
                    <a href="{{ route('documents.show', $orderReservation->document ?? $orderReservation->document_id) }}" class="inline-flex items-center px-3 py-1.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 text-gray-700 rounded-xl text-xs font-bold transition">
