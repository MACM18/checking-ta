                            ...
                            @forelse($reservations as $res)
                                <tr class="hover:bg-slate-50/70 transition group">
                                    ...
                                    <td class="sticky right-0 z-10 bg-white group-hover:bg-slate-50 transition px-5 py-4 whitespace-nowrap text-right space-x-2 shadow-[-8px_0_12px_-4px_rgba(0,0,0,0.06)] border-l border-gray-100">
                                        ...
                                        @if($res->document_id)
                                            <a href="{{ route('documents.show', $res->document ?? $res->document_id) }}" class="inline-flex items-center px-2 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-lg text-xs transition" title="View Source Reserve Document">
