    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('dashboard') }}#centralized-export-hub" class="inline-flex items-center px-3.5 py-2 bg-slate-50 hover:bg-indigo-50 text-slate-700 hover:text-indigo-700 border border-slate-200 hover:border-indigo-200 rounded-xl text-xs font-bold transition shadow-2xs" title="Open Centralized Reports & Exports Hub">
                    <svg class="w-3.5 h-3.5 me-1.5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                    Export Reports
                </a>
                            ...
                            @forelse($reservations as $res)
                                <tr class="hover:bg-slate-50/70 transition group">
                                    ...
                                    <td class="sticky right-0 z-10 bg-white group-hover:bg-slate-50 transition px-5 py-4 whitespace-nowrap text-right space-x-2 shadow-[-8px_0_12px_-4px_rgba(0,0,0,0.06)] border-l border-gray-100">
                                        <a href="{{ route('order-reservations.edit', $res) }}" class="inline-flex items-center px-2 py-1.5 bg-gray-50 hover:bg-indigo-50 border border-gray-200 hover:border-indigo-200 text-gray-700 hover:text-indigo-700 rounded-lg font-bold text-xs transition" title="Edit Reservation Details & Items">
                                        ...
                                        @if($res->document)
                                            <a href="{{ route('documents.show', $res->document) }}" class="inline-flex items-center px-2 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-lg text-xs transition" title="View Source Reserve Document">
                                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                            </a>
                                        @elseif($res->document_id)
